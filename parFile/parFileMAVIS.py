...
Cn2Weights          = [0.59, 0.02, 0.04, 0.06, 0.01, 0.05, 0.09, 0.04, 0.05, 0.05]      # Fractional weights of layers
Cn2Heights          = [30, 140, 281, 562, 1125, 2250, 4500, 7750, 11000, 14000]         # Layers altitude in m
...
DmHeights           = [0 , 4000 , 14000]                                                # DM altitude in m
